...
bb41:
  LA s2, .CONSTANT.7.4
  FLW fs10, 0(s2)
  FDIV.S fs11, fs2, fs10
  FCVT.W.S s2, fs11, rtz
  FCVT.S.W fs10, s2
  LA s2, .CONSTANT.7.4
  FLW fs11, 0(s2)
  FMUL.S fs7, fs10, fs11
  FSUB.S fs10, fs2, fs7
  FSGNJ.S fs8, fs10, fs10
  JAL zero, bb16
bb42:
...
bb102:
  ...
  FMUL.S fs10, fs11, fs11
  FADD.S fs11, fs8, fs10
  FDIV.S fs8, fs11, fs2
  LA s3, .CONSTANT.7.2
  FLW fs10, 0(s3)
  FADD.S ft0, fs8, fs10
  FMUL.S fs8, fs3, fs11
  FADD.S fs10, fs7, fs11
  FDIV.S ft1, fs8, fs10
  FADD.S fs8, ft0, ft1
  ADDI s3, zero, 10
  FSGNJ.S fs10, fs8, fs8
