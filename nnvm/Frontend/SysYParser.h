...
public:
  ...
  enum {
    ...
    RuleReturnStmt = 16, RuleForInit = 17, RuleForUpdate = 18, RuleStmt = 19, 
    RuleExp = 20, RuleCall = 21, RuleLVal = 22, RuleNumber = 23, RuleUnaryOp = 24, 
    RuleFuncRParams = 25, RuleParam = 26, RuleConstExp = 27
  };
